...
---
[Kashmir][kashmirwiki] is one of the most popular tourist destinations in India, situated in the [Union Territory of Jammu and Kashmir][utjk].
...
<a href="#day3">Day 3</a><br>
<a href="#day4">Day 4</a><br>
<a href="#day5">Day 5</a><br>
<a href="#day6">Day 6</a><br>
...
On Day 1, we began by visiting the [Shankaracharya Temple][temple]. Our driver brought us to the temple's base, from where we had to climb approximately 250 stairs to reach the hilltop Hindu temple. The surroundings exuded a sense of holiness. Besides the spiritual experience, this site also offered breathtaking views of Srinagar, including the [Jhelum River][jhriver] and the [Dal Lake][dallake], although the fog obscured some of the best views.
...
Srinagar, often referred to as the 'City of Gardens,' boasts many beautiful gardens. During our visit, we explored a few of them, including [Parimahal][parimahal], [Chashma Shahi Garden][chashmashahi], [Shalimar Bagh Mughal Garden][shalimargarden], and [Nishat Garden][nishatgarden].

Parimahal is a multi-level garden built on a mountain slope, offering spectacular views.

{% include function_travelimg.html img="Pari-01.jpg" alt="View of Dal Lake from Parimahal" %}
{% include function_travelimg.html img="Pari-02.jpg" alt="Multiple levels at Parimahal" %}
{% include function_travelimg.html img="Pari-03.jpg" alt="View of Raj Bhavan from Parimahal" %}
{% include function_travelimg.html img="Pari-04.jpg" alt="Parimahal" %}
...
{% include function_travelimg.html img="Chasme-01.jpg" alt="Chashma Shahi Garden" %}
...
{% include function_travelimg.html img="Shalimar-01.jpg" alt="Elegant garden at Shalimar Bagh" %}
{% include function_travelimg.html img="Shalimar-02.jpg" alt="Active fountains at the entrance of Shalimar Bagh" %}
{% include function_travelimg.html img="Shalimar-03.jpg" alt="View of the nearby mountain range from Shalimar Bagh" %}
{% include function_travelimg.html img="Shalimar-04.jpg" alt="View of the nearby mountain range from Shalimar Bagh" %}
{% include function_travelimg.html img="Shalimar-05.jpg" alt="Old inactive fountains at Shalimar Bagh" %}
{% include function_travelimg.html img="Shalimar-06.jpg" alt="A whimsical spot at Shalimar Bagh" %}
...
{% include function_travelimg.html img="Nishat-01.jpg" alt="Nishat Garden" %}
{% include function_travelimg.html img="Nishat-02.jpg" alt="Nishat Garden" %}
{% include function_travelimg.html img="Nishat-03.jpg" alt="Nishat Garden" %}
{% include function_travelimg.html img="Nishat-04.jpg" alt="Nishat Garden" %}
{% include function_travelimg.html img="Nishat-05.jpg" alt="Nishat Garden" %}
{% include function_travelimg.html img="Nishat-06.jpg" alt="Nishat Garden" %}
{% include function_travelimg.html img="Nishat-07.jpg" alt="Nishat Garden" %}


<a name="day2" id="day2"></a>
...
{% include function_travelimg.html img="WayToZeroPoint-01.jpg" alt="Way to Zero Point" %}
{% include function_travelimg.html img="WayToZeroPoint-02.jpg" alt="Way to Zero Point" %}
{% include function_travelimg.html img="WayToZeroPoint-03.jpg" alt="Way to Zero Point" %}
{% include function_travelimg.html img="WayToZeroPoint-04.jpg" alt="Way to Zero Point" %}
{% include function_travelimg.html img="WayToZeroPoint-05.jpg" alt="Way to Zero Point" %}
{% include function_travelimg.html img="WayToZeroPoint-06.jpg" alt="Way to Zero Point" %}
{% include function_travelimg.html img="WayToZeroPoint-07.jpg" alt="Way to Zero Point" %}
{% include function_travelimg.html img="WayToZeroPoint-08.jpg" alt="Way to Zero Point" %}
{% include function_travelimg.html img="WayToZeroPoint-09.jpg" alt="Way to Zero Point" %}
{% include function_travelimg.html img="WayToZeroPoint-10.jpg" alt="Way to Zero Point" %}
{% include function_travelimg.html img="WayToZeroPoint-11.jpg" alt="Way to Zero Point" %}
{% include function_travelimg.html img="WayToZeroPoint-12.jpg" alt="Way to Zero Point" %}
{% include function_travelimg.html img="WayToZeroPoint-13.jpg" alt="Way to Zero Point" %}
...
{% include function_travelimg.html img="ZeroPoint-01.jpg" alt="Zero Point" %}
{% include function_travelimg.html img="ZeroPoint-02.jpg" alt="Zero Point" %}
{% include function_travelimg.html img="ZeroPoint-03.jpg" alt="Zero Point" %}

At the end of the day, we returned to Srinagar.


<a name="day3" id="day3"></a>
...
{% include function_travelimg.html img="Dudh-01.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-02.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-03.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-04.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-05.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-06.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-07.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-08.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-09.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-10.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-11.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-12.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-13.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-14.jpg" alt="Doodhpathri" %}
{% include function_travelimg.html img="Dudh-15.jpg" alt="Doodhpathri" %}
...
{% include function_travelimg.html img="Gulmarg-01.jpg" alt="Gulmarg" %}
{% include function_travelimg.html img="Gulmarg-02.jpg" alt="Gulmarg" %}
{% include function_travelimg.html img="Gulmarg-03.jpg" alt="Gulmarg" %}
{% include function_travelimg.html img="Gulmarg-04.jpg" alt="Gulmarg" %}
{% include function_travelimg.html img="Gulmarg-05.jpg" alt="Gulmarg" %}
{% include function_travelimg.html img="Gulmarg-06.jpg" alt="Gulmarg" %}
{% include function_travelimg.html img="Gulmarg-07.jpg" alt="Gulmarg" %}
...
{% include function_travelimg.html img="Gondola-01.jpg" alt="Gondola" %}
{% include function_travelimg.html img="Gondola-02.jpg" alt="Gondola" %}
{% include function_travelimg.html img="Gondola-03.jpg" alt="Gondola" %}
{% include function_travelimg.html img="Gondola-04.jpg" alt="Gondola" %}
{% include function_travelimg.html img="Gondola-05.jpg" alt="Gondola" %}
{% include function_travelimg.html img="Gondola-06.jpg" alt="Gondola" %}
{% include function_travelimg.html img="Gondola-07.jpg" alt="Gondola" %}
...
{% include function_travelimg.html img="GondolaHill-01.jpg" alt="GondolaHill" %}
{% include function_travelimg.html img="GondolaHill-02.jpg" alt="GondolaHill" %}
{% include function_travelimg.html img="GondolaHill-03.jpg" alt="GondolaHill" %}
{% include function_travelimg.html img="GondolaHill-04.jpg" alt="GondolaHill" %}
...
{% include function_travelimg.html img="Pahel-01.jpg" alt="Pahalgam" %}
{% include function_travelimg.html img="Pahel-02.jpg" alt="Pahalgam" %}
{% include function_travelimg.html img="Pahel-03.jpg" alt="Pahalgam" %}
{% include function_travelimg.html img="Pahel-04.jpg" alt="Pahalgam" %}
...
{% include function_travelimg.html img="Baisaran-01.jpg" alt="Baisaran Valley" %}
{% include function_travelimg.html img="Baisaran-02.jpg" alt="Baisaran Valley" %}
{% include function_travelimg.html img="Baisaran-03.jpg" alt="Baisaran Valley" %}
...
{% include function_travelimg.html img="Aru-01.jpg" alt="Aru Valley" %}
{% include function_travelimg.html img="Aru-02.jpg" alt="Aru Valley" %}
{% include function_travelimg.html img="Aru-03.jpg" alt="Aru Valley" %}
{% include function_travelimg.html img="Aru-04.jpg" alt="Aru Valley" %}
{% include function_travelimg.html img="Aru-05.jpg" alt="Aru Valley" %}
{% include function_travelimg.html img="Aru-06.jpg" alt="Aru Valley" %}
{% include function_travelimg.html img="Aru-07.jpg" alt="Aru Valley" %}

{% include function_travelimg.html img="Betaab-01.jpg" alt="Betaab Valley" %}
{% include function_travelimg.html img="Betaab-02.jpg" alt="Betaab Valley" %}
{% include function_travelimg.html img="Betaab-03.jpg" alt="Betaab Valley" %}
{% include function_travelimg.html img="Betaab-04.jpg" alt="Betaab Valley" %}

<a name="day6" id="day6"></a>
...
{% include function_travelimg.html img="Apple-01.jpg" alt="Stopping at an apple garden" %}

{% include function_travelimg.html img="Dal-01.jpg" alt="Dal Lake from Shikara" %}
